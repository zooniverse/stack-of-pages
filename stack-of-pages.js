...
(function() {
  var StackOfPages, dispatchEvent,
  ...
  StackOfPages = (function() {
    ...
    StackOfPages.prototype.activatePage = function() {
      ...
      if (typeof target.activate === "function") {
        target.activate.apply(target, params);
      }
      return dispatchEvent(el, 'stack-activate', params);
    };
    ...
    StackOfPages.prototype.deactivatePage = function() {
      ...
      if (typeof target.deactivate === "function") {
        target.deactivate.apply(target, params);
      }
      return dispatchEvent(el, 'stack-deactivate', params);
    };
